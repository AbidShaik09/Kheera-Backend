...
| Backend design boundaries | In progress | Backend [#46](https://github.com/AbidShaik09/Kheera-Backend/issues/46). | Merge user DTO projections, service transaction boundaries, and production JPA safety defaults. |
